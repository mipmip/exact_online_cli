module ExactOnlineCli
  class TimeAndBillingEntryProjectsByAccountAndDate < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_entry_projects_by_account_and_date'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingEntryProjectsByAccountAndDate'
