module ExactOnlineCli
  class CostEntryRecentExpensesByProject < ExactOnlineCli::ResourceSubcommand

    @plural = 'cost_entry_recent_expenses_by_project'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::CostEntryRecentExpensesByProject'
