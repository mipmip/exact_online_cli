module ExactOnlineCli
  class TimeAndBillingItemDetailsByID < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_item_details_by_id'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingItemDetailsByID'
