module ExactOnlineCli
  class AgingPayablesListByAgeGroup < ExactOnlineCli::ResourceSubcommand

    @plural = 'aging_payables_list_by_age_group'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::AgingPayablesListByAgeGroup'
