module ExactOnlineCli
  class TimeAndBillingEntryAccounts < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_entry_accounts'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingEntryAccounts'
