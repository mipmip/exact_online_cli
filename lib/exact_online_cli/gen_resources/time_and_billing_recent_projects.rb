module ExactOnlineCli
  class TimeAndBillingRecentProjects < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_recent_projects'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingRecentProjects'
