module ExactOnlineCli
  class SubscriptionRestrictionItems < ExactOnlineCli::ResourceSubcommand

    @plural = 'subscription_restriction_items'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::SubscriptionRestrictionItems'
