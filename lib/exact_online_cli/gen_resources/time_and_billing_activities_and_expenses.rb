module ExactOnlineCli
  class TimeAndBillingActivitiesAndExpenses < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_activities_and_expenses'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingActivitiesAndExpenses'
