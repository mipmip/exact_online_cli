module ExactOnlineCli
  class TimeAndBillingAccountDetailsByID < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_account_details_by_id'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingAccountDetailsByID'
