module ExactOnlineCli
  class IndicatorDeviatingAmountEntereds < ExactOnlineCli::ResourceSubcommand

    @plural = 'indicator_deviating_amount_entereds'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::IndicatorDeviatingAmountEntereds'
