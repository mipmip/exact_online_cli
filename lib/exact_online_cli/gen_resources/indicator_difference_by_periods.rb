module ExactOnlineCli
  class IndicatorDifferenceByPeriods < ExactOnlineCli::ResourceSubcommand

    @plural = 'indicator_difference_by_periods'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::IndicatorDifferenceByPeriods'
