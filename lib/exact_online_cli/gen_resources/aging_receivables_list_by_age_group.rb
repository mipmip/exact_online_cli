module ExactOnlineCli
  class AgingReceivablesListByAgeGroup < ExactOnlineCli::ResourceSubcommand

    @plural = 'aging_receivables_list_by_age_group'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::AgingReceivablesListByAgeGroup'
