module ExactOnlineCli
  class ProjectRestrictionRebillings < ExactOnlineCli::ResourceSubcommand

    @plural = 'project_restriction_rebillings'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::ProjectRestrictionRebillings'
