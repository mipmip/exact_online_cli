module ExactOnlineCli
  class HourEntryRecentAccountsByProject < ExactOnlineCli::ResourceSubcommand

    @plural = 'hour_entry_recent_accounts_by_project'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::HourEntryRecentAccountsByProject'
