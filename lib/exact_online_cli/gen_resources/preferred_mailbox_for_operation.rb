module ExactOnlineCli
  class PreferredMailboxForOperation < ExactOnlineCli::ResourceSubcommand

    @plural = 'preferred_mailbox_for_operation'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::PreferredMailboxForOperation'
