module ExactOnlineCli
  class HourEntryActivitiesByProject < ExactOnlineCli::ResourceSubcommand

    @plural = 'hour_entry_activities_by_project'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::HourEntryActivitiesByProject'
