module ExactOnlineCli
  class TimeAndBillingEntryProjects < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_entry_projects'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingEntryProjects'
