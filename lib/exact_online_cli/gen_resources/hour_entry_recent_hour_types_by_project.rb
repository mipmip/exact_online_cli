module ExactOnlineCli
  class HourEntryRecentHourTypesByProject < ExactOnlineCli::ResourceSubcommand

    @plural = 'hour_entry_recent_hour_types_by_project'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::HourEntryRecentHourTypesByProject'
