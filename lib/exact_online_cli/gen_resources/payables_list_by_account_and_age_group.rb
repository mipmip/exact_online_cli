module ExactOnlineCli
  class PayablesListByAccountAndAgeGroup < ExactOnlineCli::ResourceSubcommand

    @plural = 'payables_list_by_account_and_age_group'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::PayablesListByAccountAndAgeGroup'
