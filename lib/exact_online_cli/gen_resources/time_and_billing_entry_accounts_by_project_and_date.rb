module ExactOnlineCli
  class TimeAndBillingEntryAccountsByProjectAndDate < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_entry_accounts_by_project_and_date'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingEntryAccountsByProjectAndDate'
