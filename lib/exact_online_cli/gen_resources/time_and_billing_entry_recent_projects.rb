module ExactOnlineCli
  class TimeAndBillingEntryRecentProjects < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_entry_recent_projects'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingEntryRecentProjects'
