module ExactOnlineCli
  class TimeAndBillingAccountDetails < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_account_details'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingAccountDetails'
