module ExactOnlineCli
  class TimeAndBillingEntryProjectsByDate < ExactOnlineCli::ResourceSubcommand

    @plural = 'time_and_billing_entry_projects_by_date'
    include ResourceSubcommandInclude

    def initialize(*args)
      super
      @elmas_class = 'Elmas::TimeAndBillingEntryProjectsByDate'
